...
function LoginPage() {
  ...
  const googleLogIn = async () => {
    ...
    try {
      ...
      const googleName = result.user.displayName as string; // Firebase will share the User Name
      ...
      // Covers popup closed by user, popup blocked, network failure
    ...
    <>
      {showLogin ? (
        <div className="login-container">
          ...
          {errors.auth && (
            <div className="error-banner text-body">{errors.auth}</div>
          )}
          ...
          <div className="input-container">
            ...
            >
              ...
              <EyeIcon className="icon-show-pwd" size={16} aria-hidden="true" />
            </button>
            <button
          ...
          >
            ...
            >
              ...
              <p className="text-body">
                Buy products from local producers and get them in reusable
                containers.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-body">
                Sell your products and ship them with our reusable packaging.
              </p>
            </div>
          </div>
        ...
        <div className="signup-text">
          {showLogin ? (
            <div className="join-us-claim">
              ...
              <br></br>
              <p className="text-body">
                Join our community and become part of the changing world
              </p>
            </div>
          ) : (
            <div className="join-us-claim">
