...
interface ProducerProductCardProps {
  ...
  onUpdateProduct: (productId: string, editData: EditData) => void;
}

function ProducerProductCard({ product, onUpdateQuantity, onUpdateProduct }: ProducerProductCardProps) {
    ...
    <>
      ...
      <div className="producer-product-card">
        ...
        <div className="prod-qty-buttons">
          ...
          <button
            className="prod-btn-add-one btn btn--primary"
            onClick={handleAdd}
          ...
          <button
            className="prod-btn-remove-one btn btn--destructive"
