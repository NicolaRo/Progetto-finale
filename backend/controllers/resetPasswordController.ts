...
const requestPasswordReset = async (req: Request<{}, {}, RequestResetInput>, res: Response) => {
    try {
...
const resetPassword = async (req: Request<{ token: string }, {}, ResetPasswordInput>, res: Response) => {
    try {
